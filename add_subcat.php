...
if(isset($_POST['submit']))
{
    ...
    $exe = $obj->query("insert into sub_cat(sub_name,cat_id) values('$c_name','$s1')");
	if($exe)
	{
                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal " id="signupForm" method="post" action="" novalidate="novalidate">
                                    <div class="form-group ">
                                        <label for="s_cat" class="control-label col-lg-3">Sub-Categroy</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="s_cat" name="s_cat" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
